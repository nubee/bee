...
class nbSymfony2InitCommand extends nbApplicationCommand {

  protected function configure() {
    $this->setName('Symfony2:init')
            ->setBriefDescription('Initliazes a Symfony2 website project (creates and restores database, makes directories for symfony application)')
            ->setDescription(<<<TXT
Examples:
...
TXT
  ...
  protected function execute(array $arguments = array(), array $options = array()) {
    ...
    $this->logLine('Symfony2 website initialized successfully', nbLogger::INFO);
