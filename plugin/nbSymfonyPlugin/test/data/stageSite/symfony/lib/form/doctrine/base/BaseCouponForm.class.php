...
abstract class BaseCouponForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'espires_at'      => new sfWidgetFormDateTime(),
      'offer_code'      => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'issued_at'       => new sfValidatorDateTime(),
      'espires_at'      => new sfValidatorDateTime(),
      'offer_code'      => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'validation_code' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'validate_at'     => new sfValidatorDateTime(),
