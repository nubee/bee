 ...
 * @method sfGuardUser           setCompanies()             Sets the current record's "Companies" collection
 * @method sfGuardUser           setCoupons()               Sets the current record's "Coupons" collection
 * @method sfGuardUser           setFeedbacks()             Sets the current record's "Feedbacks" collection
