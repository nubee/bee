...
$snr = new File_SearchReplace( $search, $replace, (array) $onefilename);
...
<TR><TH>Select Preferred Mirror</TH></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=unc OnClick="form.submit()">unc (US)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=internap OnClick="form.submit()">internap (US)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=kent OnClick="form.submit()">kent (UK)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=aleron OnClick="form.submit()">aleron (US)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=optusnet OnClick="form.submit()">optusnet (AU)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=jaist OnClick="form.submit()">jaist (JP)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=puzzle OnClick="form.submit()">puzzle (CH)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=heanet OnClick="form.submit()">heanet (IE)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=mesh OnClick="form.submit()">mesh (DE)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=ovh OnClick="form.submit()">ovh (FR)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=voxel OnClick="form.submit()">voxel (US)
</TD></TR><TR xpatternx <TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=umn OnClick="form.submit()">umn (US)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT  TYPE=RADIO NAME=use_default VALUE=belnet OnClick="form.submit()">belnet (BE)
</TD></TR><TR BGCOLOR=#CCCCFF><TD align=left> xpatternx  xpatternx  xpatternx  xpatternx  xpatternx  xpatternx <INPUT checked TYPE=RADIO NAME=use_default VALUE=none OnClick="form.submit()"><b>none</b> 
