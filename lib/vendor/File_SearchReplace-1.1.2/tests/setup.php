...
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=internap OnClick="form.submit()">internap (US)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=kent OnClick="form.submit()">kent (UK)
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=aleron OnClick="form.submit()">aleron (US)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=optusnet OnClick="form.submit()">optusnet (AU)
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=jaist OnClick="form.submit()">jaist (JP)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=puzzle OnClick="form.submit()">puzzle (CH)
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=heanet OnClick="form.submit()">heanet (IE)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=mesh OnClick="form.submit()">mesh (DE)
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=ovh OnClick="form.submit()">ovh (FR)
</TD></TR><TR BGCOLOR=#DDDDDD><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=voxel OnClick="form.submit()">voxel (US)
</TD></TR><TR BGCOLOR=#EEEEEE><TD align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT  TYPE=RADIO NAME=use_default VALUE=umn OnClick="form.submit()">umn (US)
